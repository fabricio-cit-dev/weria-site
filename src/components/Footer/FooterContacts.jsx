    ...
    <>
      <div className="footer-contacts">
        <div className="email-contact">
          <img src={emailicon} alt="email-icon" className="emai-footer-icon" style={{backgroundColor: "#ff9100", borderRadius: "50%", padding: "5px", marginRight: "5px"}}></img>
           contato@incript.com.br
        </div>
        <div className="location-container">
          <div>
            <img src={localiicon} alt="localização" className="locali-icon" style={{backgroundColor: "#ff9100", borderRadius: "50%", padding: "5px", marginRight: "5px"}}></img>
